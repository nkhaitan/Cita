...
- (void) drawRect:(CGRect)rect
{
    ...
    NSArray* colors = [NSArray arrayWithObjects:(id) [UIColor colorWithIntRed:215 green:0 blue:15].CGColor, (id) [UIColor colorWithIntRed:25 green:89 blue:189].CGColor, nil];
